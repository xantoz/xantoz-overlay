...
# need at least dev-lang/rust:1.85 because that's when edition2024 was stablizied
# does not build properly on dev-lang/rust:1.90 due to a -Werror oopsie in mime/mime-parse crates
# (the latter could alternatively be solved, but would likely need to override the crate)
RUST_MIN_VER=1.85
RUST_MAX_VER=1.89
